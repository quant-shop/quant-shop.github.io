...
\hypersetup{
  pdftitle={How much data do you want for your progress? Quantitative History and the Study of Social Problems},
...
\title{How much \emph{data} do you want for your progress? Quantitative
History and the Study of Social Problems}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{img/spring-2007-unc-math.jpg}

\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{img/assani.avif}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\url{https://www.youtube.com/embed/UBFDdTIYZ6Q?si=7xi64TzYH1eIjOtB}
...
{How might information theories inform interdisciplinary curriculum and
...
\item
  ...
  perspective.
\item
  Namely, how might faculty and educators {leverage computation and
  quantification} to transmit information efficiently while {maintaining
  the roots of complex theories and concepts?}
\end{itemize}
